...
| Layer | What's here |
|---|---|
| Base image | `dhi.io/python:3.13` — Docker Hardened Image, distroless, near-zero CVEs, SLSA Build Level 3 from Docker |
...
| Metric | Baseline (`python:3.13-slim`) | Hardened (`dhi.io/python:3.13`) | Change |
|---|---|---|---|
...
Full breakdown in [the project's writeup](https://github.com/LennartOnGit/hardad).
